...
const PANEL_VERSION = "2.4.9";

/** Permanent download URLs — GitHub Releases (not committed to `public/`) */
const DOWNLOAD_WIN =
  "https://github.com/mahmutbegoviicalmin-coder/prysmor.io/releases/download/v2.4.9/PrysmrSetup.exe";
const DOWNLOAD_MAC =
  "https://github.com/mahmutbegoviicalmin-coder/prysmor.io/releases/download/v2.4.9/Prysmor-2.4.9.pkg";
