...
const PANEL_VERSION = "3.0.6";

/** Permanent download URLs — GitHub Releases (not committed to `public/`) */
const DOWNLOAD_WIN =
  "https://github.com/mahmutbegoviicalmin-coder/prysmor.io/releases/download/v3.0.6/PrysmrSetup.exe";
const DOWNLOAD_MAC =
  "https://github.com/mahmutbegoviicalmin-coder/prysmor.io/releases/download/v3.0.6/Prysmor-3.0.6.pkg";
