...
const PANEL_VERSION = "2.6.2";

/** Permanent download URLs — GitHub Releases (not committed to `public/`) */
const DOWNLOAD_WIN =
  "https://github.com/mahmutbegoviicalmin-coder/prysmor.io/releases/download/v2.6.2/PrysmrSetup.exe";
const DOWNLOAD_MAC =
  "https://github.com/mahmutbegoviicalmin-coder/prysmor.io/releases/download/v2.6.2/Prysmor-2.6.2.pkg";
