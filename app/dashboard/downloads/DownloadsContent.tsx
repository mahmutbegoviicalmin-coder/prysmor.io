...
const PANEL_VERSION = "2.7.3";

/** Permanent download URLs — GitHub Releases (not committed to `public/`) */
const DOWNLOAD_WIN =
  "https://github.com/mahmutbegoviicalmin-coder/prysmor.io/releases/download/v2.7.3/PrysmrSetup.exe";
const DOWNLOAD_MAC =
  "https://github.com/mahmutbegoviicalmin-coder/prysmor.io/releases/download/v2.7.3/Prysmor-2.7.3.pkg";
