...
const POLL_MS         = 5000;
const PANEL_VERSION_DEFAULT = '5.5.7'; // keep in sync with panel/version.txt
...
function renderUsage() {
  ...
  // Animate the big number as seconds remaining
  ...
  // Seconds remaining (never-expires callout for lifetime)
