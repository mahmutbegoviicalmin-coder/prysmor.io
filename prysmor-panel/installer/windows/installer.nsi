; Prysmor CEP Panel — Windows NSIS (CI + local)
; Run from repo root:
;   "C:\Program Files (x86)\NSIS\makensis.exe" prysmor-panel\installer\windows\installer.nsi
; Output: dist\PrysmrSetup.exe

Unicode True

!define PRODUCT_NAME      "Prysmor"
!define PRODUCT_VERSION   "5.5.3"
